...
<required_reading>
@./.opencode/get-physics-done/references/verification/core/verification-core.md
@./.opencode/get-physics-done/references/verification/core/verification-numerical.md
@./.opencode/get-physics-done/references/protocols/error-propagation-protocol.md
@./.opencode/get-physics-done/templates/verification-report.md
</required_reading>
...
**Verification independence:** Load only what the verifier needs to judge results on their own merits. See @./.opencode/get-physics-done/references/verification/meta/verification-independence.md.
...
5. Reference: @./.opencode/get-physics-done/workflows/numerical-convergence.md for detailed methodology
...
Reference: @./.opencode/get-physics-done/references/verification/core/verification-core.md (+ relevant domain verification file)
...
See ./.opencode/get-physics-done/templates/verification-report.md for complete template.
</step>
