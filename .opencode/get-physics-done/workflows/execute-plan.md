...
Read these reference files using the read_file tool:
- ./.opencode/get-physics-done/references/execution/git-integration.md
- ./.opencode/get-physics-done/references/execution/execute-plan-recovery.md
- ./.opencode/get-physics-done/references/execution/execute-plan-validation.md
- ./.opencode/get-physics-done/references/execution/execute-plan-checkpoints.md
- ./.opencode/get-physics-done/references/protocols/reproducibility.md
- ./.opencode/get-physics-done/references/protocols/error-propagation-protocol.md -- Cross-phase uncertainty propagation protocol (Uncertainty Budget declaration format, verification checks, phase handoff format)
- ./.opencode/get-physics-done/references/execution/executor-index.md -- Maps execution scenarios (QFT, condensed matter, numerical, paper writing, debugging) to the correct domain-specific reference files
- ./.opencode/get-physics-done/templates/calculation-log.md -- Template for CALCULATION_LOG.md (detailed derivation records within a phase)
- ./.opencode/get-physics-done/templates/recovery-plan.md -- Template for RECOVERY.md (structured recovery after plan execution failure)
</required_reading>
...
If pausing mid-plan: commit current work, create `.continue-here.md` with full derivation state, recommend `/clear` + `/gpd-resume-work`. See `./.opencode/get-physics-done/references/orchestration/context-budget.md` for budget guidelines.
...
See `execute-plan-checkpoints.md` for the full checkpoint protocol (display format, types, resume signals) and `./.opencode/get-physics-done/references/orchestration/checkpoints.md` for general checkpoint details.
...
Create `${phase}-${plan}-SUMMARY.md` at `${phase_dir}/`. Use `./.opencode/get-physics-done/templates/summary.md`.
