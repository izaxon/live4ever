...
If you need to provide a manual JSON instead, use `@./.opencode/get-physics-done/templates/paper/paper-quality-input-schema.md` as the schema source of truth.
