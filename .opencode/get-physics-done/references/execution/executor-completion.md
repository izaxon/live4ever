...
**Recovery protocol:** If a gpd CLI command fails twice, read the target file manually, make the state update via edit_file tool, and document the manual fix in the plan SUMMARY.md.
