...
<references>
- `@./.opencode/get-physics-done/references/verification/core/verification-core.md` -- Universal verification checks and priority patterns
- `@./.opencode/get-physics-done/references/physics-subfields.md` -- Methods, tools, and validation strategies per physics subfield
- `@./.opencode/get-physics-done/references/verification/errors/llm-physics-errors.md` -- Common LLM physics errors to check against
