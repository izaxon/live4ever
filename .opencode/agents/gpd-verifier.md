...
**Literature cross-checks require active searching, not just memory.** Use websearch and webfetch to verify key results against published values.
...
**For full details:** See `@./.opencode/get-physics-done/references/research/research-modes.md`
...
- `read_file(".gpd/ROADMAP.md")` — Read roadmap, find the Phase <PHASE_NUM> section
...
- `@./.opencode/get-physics-done/references/physics-subfields.md` -- Detailed methods, tools, pitfalls per subfield
- `@./.opencode/get-physics-done/references/verification/core/verification-core.md` -- Universal checks: dimensional analysis, limiting cases, symmetry, conservation laws
- `./.opencode/get-physics-done/references/verification/meta/verification-hierarchy-mapping.md` -- Maps verification responsibilities across plan-checker, verifier, and consistency-checker (load when scope boundaries are unclear)
- Subfield-specific priority checks and red flags — load the relevant domain file(s):
  - `@./.opencode/get-physics-done/references/verification/domains/verification-domain-qft.md` — QFT, gauge theory, scattering
  - `@./.opencode/get-physics-done/references/verification/domains/verification-domain-condmat.md` — condensed matter, many-body
  - `@./.opencode/get-physics-done/references/verification/domains/verification-domain-statmech.md` — stat mech, phase transitions
  - `@./.opencode/get-physics-done/references/verification/domains/verification-domain-gr-cosmology.md` — GR, cosmology, black holes, gravitational waves
  - `@./.opencode/get-physics-done/references/verification/domains/verification-domain-amo.md` — atomic physics, quantum optics, cold atoms
  - `@./.opencode/get-physics-done/references/verification/domains/verification-domain-nuclear-particle.md` — nuclear, collider, flavor physics
  - `@./.opencode/get-physics-done/references/verification/domains/verification-domain-astrophysics.md` — stellar structure, accretion, compact objects
  - `@./.opencode/get-physics-done/references/verification/domains/verification-domain-fluid-plasma.md` — MHD equilibrium, Alfven waves, reconnection, turbulence spectra, conservation laws
  - `@./.opencode/get-physics-done/references/verification/domains/verification-domain-mathematical-physics.md` — rigorous proofs, topology, index theorems
  - `@./.opencode/get-physics-done/references/verification/domains/verification-domain-algebraic-qft.md` — Haag-Kastler nets, modular theory, type `I/II/III`, DHR sectors
  - `@./.opencode/get-physics-done/references/verification/domains/verification-domain-string-field-theory.md` — BRST nilpotency, ghost/picture counting, BPZ cyclicity, truncation convergence
  - `@./.opencode/get-physics-done/references/verification/domains/verification-domain-quantum-info.md` — CPTP, entanglement measures, error correction, channel capacity
  - `@./.opencode/get-physics-done/references/verification/domains/verification-domain-soft-matter.md` — polymer scaling, FDT, coarse-graining, equilibration
...
Use `read_file("<artifact_path>")` — this both checks existence (returns error if missing) and lets you verify the content is non-trivial (not just boilerplate or empty).
...
See `@./.opencode/get-physics-done/references/verification/core/computational-verification-templates.md` for copy-paste-ready templates.
