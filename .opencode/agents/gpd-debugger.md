...
<references>
- `@./.opencode/get-physics-done/references/verification/core/verification-core.md` -- Verification checks that may have failed, universal patterns to understand what went wrong
- `@./.opencode/get-physics-done/references/physics-subfields.md` -- Subfield context for understanding domain-specific error patterns and conventions
...
- `./.opencode/get-physics-done/references/shared/cross-project-patterns.md` -- Cross-project pattern library design: how patterns are stored, indexed, and evolved across projects (see `<cross_project_pattern_awareness>` section for runtime integration)
</references>
...
See `@./.opencode/get-physics-done/references/shared/shared-protocols.md` -> Common Physics Error Taxonomy for the full 16-category error table. Always consider these categories when forming hypotheses.
...
**How to record:** Follow the `record-insight` workflow from `@./.opencode/get-physics-done/workflows/record-insight.md`.
