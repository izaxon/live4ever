...
task(
  ...
  model="{read_model}",
  readonly=false,
  prompt="First, read ./.opencode/agents/gpd-review-reader.md for your role and instructions.
Then read ./.opencode/get-physics-done/references/publication/peer-review-panel.md and use its `ClaimIndex` / `StageReviewReport` artifact contract exactly.
...
task(
  ...
  readonly=false,
  prompt="First, read ./.opencode/agents/gpd-review-literature.md for your role and instructions.
Then read ./.opencode/get-physics-done/references/publication/peer-review-panel.md and use its `StageReviewReport` artifact contract exactly.
...
task(
  ...
  model="{math_model}",
  readonly=false,
  prompt="First, read ./.opencode/agents/gpd-review-math.md for your role and instructions.
Then read ./.opencode/get-physics-done/references/publication/peer-review-panel.md and use its `StageReviewReport` artifact contract exactly.
...
task(
  ...
  model="{physics_model}",
  readonly=false,
  prompt="First, read ./.opencode/agents/gpd-review-physics.md for your role and instructions.
Then read ./.opencode/get-physics-done/references/publication/peer-review-panel.md and use its `StageReviewReport` artifact contract exactly.
...
task(
  ...
  readonly=false,
  prompt="First, read ./.opencode/agents/gpd-review-significance.md for your role and instructions.
Then read ./.opencode/get-physics-done/references/publication/peer-review-panel.md and use its `StageReviewReport` artifact contract exactly.
...
task(
  ...
  model="{referee_model}",
  readonly=false,
  prompt="First, read ./.opencode/agents/gpd-referee.md for your role and instructions.
Then read ./.opencode/get-physics-done/references/publication/peer-review-panel.md, ./.opencode/get-physics-done/templates/paper/review-ledger-schema.md, and ./.opencode/get-physics-done/templates/paper/referee-decision-schema.md before you write any adjudication artifacts.
...
**Follow the peer-review workflow** from `@./.opencode/get-physics-done/workflows/peer-review.md`.
