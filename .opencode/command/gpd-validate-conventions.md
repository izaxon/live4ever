...
<!-- [included: validate-conventions.md] -->
<purpose>
...
task(
  ...
  readonly=false,
  prompt="First, read ./.opencode/agents/gpd-consistency-checker.md for your role and instructions.
...
<project_context>
read_file: .gpd/CONVENTIONS.md, .gpd/STATE.md, .gpd/state.json
read_file affected phase SUMMARY.md files.
</project_context>
...
<process>
Execute the validate-conventions workflow from @./.opencode/get-physics-done/workflows/validate-conventions.md end-to-end.
