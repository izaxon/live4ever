...
- ./.opencode/get-physics-done/templates/paper/internal-comparison.md -- Template for decisive internal comparisons and verdict ledgers
</required_reading>
...
Execute the compare-results workflow from @./.opencode/get-physics-done/workflows/compare-results.md end-to-end.
