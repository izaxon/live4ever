...
<required_reading>
<!-- @ include not resolved: ./.opencode/get-physics-done/references/orchestration/continuation-format.md -->
</required_reading>
...
<process>
**Follow the resume-work workflow** from `@./.opencode/get-physics-done/workflows/resume-work.md`.
