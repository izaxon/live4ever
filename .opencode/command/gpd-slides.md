...
> **Platform note:** If `question` is not available, ask the same missing questions inline in one compact batch and wait for the user's freeform response.
</step>
...
- `./.opencode/get-physics-done/templates/slides/presentation-brief.md`
- `./.opencode/get-physics-done/templates/slides/outline.md`
- `./.opencode/get-physics-done/templates/slides/slides.md`
- `./.opencode/get-physics-done/templates/slides/speaker-notes.md`
- `./.opencode/get-physics-done/templates/slides/main.tex`
</step>
...
Follow the slides workflow from `@./.opencode/get-physics-done/workflows/slides.md` end-to-end.
