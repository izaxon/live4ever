...
<!-- [included: respond-to-referees.md] -->
<purpose>
...
```bash
cat ./.opencode/get-physics-done/templates/paper/referee-response.md
```
...
<process>
Execute the respond-to-referees workflow from @./.opencode/get-physics-done/workflows/respond-to-referees.md end-to-end.
