...
See ./.opencode/get-physics-done/templates/research.md for the RESEARCH.md template structure (use `depth: quick` for discovery-level output).
</source_hierarchy>
...
6. **Create RESEARCH.md** using ./.opencode/get-physics-done/templates/research.md structure:
...
1. **Scope the discovery** using ./.opencode/get-physics-done/templates/research.md:
...
6. **Create comprehensive RESEARCH.md:**
   ...
   - Full structure from ./.opencode/get-physics-done/templates/research.md
...
Use ./.opencode/get-physics-done/templates/research.md.
...
<process>
Execute the discover workflow from @./.opencode/get-physics-done/workflows/discover.md end-to-end.
