...
2. Optionally add a short hypothesis note to `STATE.md` via edit_file tool. After the `## Current Position` section, add:
...
<process>
Execute the branch-hypothesis workflow from @./.opencode/get-physics-done/workflows/branch-hypothesis.md end-to-end.
