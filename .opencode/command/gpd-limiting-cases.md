...
- **If init fails or `state_exists` is false** (standalone usage): Proceed with explicit convention declarations required from user via question.
...
Follow the limiting-cases workflow: @./.opencode/get-physics-done/workflows/limiting-cases.md
