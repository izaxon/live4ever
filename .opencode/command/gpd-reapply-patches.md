...
```bash
PATCHES_DIR="./.opencode/gpd-local-patches"
GLOBAL_PATCHES_DIR="/home/johan/.config/opencode/gpd-local-patches"
...
<process>
Follow the reapply-patches workflow: @./.opencode/get-physics-done/workflows/reapply-patches.md
</process>
