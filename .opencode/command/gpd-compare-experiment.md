...
<!-- [included: compare-experiment.md] -->
<purpose>
Systematically compare theoretical predictions with experimental or observational data. Handles unit conversion, uncertainty propagation, statistical testing, and discrepancy analysis.
...
- ./.opencode/get-physics-done/templates/paper/experimental-comparison.md -- Template for systematic theory-experiment comparison (data source metadata, unit conversion checklist, pull calculation, discrepancy classification, root cause hierarchy)
</required_reading>
...
- **If `state_exists` is false** (standalone usage): Proceed with explicit convention declarations required from user via question (unit system, sign conventions, normalization)
...
Use question if data source is ambiguous:
...
Follow the compare-experiment workflow: @./.opencode/get-physics-done/workflows/compare-experiment.md
</process>
