...
4. Update ROADMAP.md progress table if one exists -- the superseded phase should show status "Superseded" rather than "Complete". Use the edit_file tool for this ROADMAP.md change (not STATE.md).
...
Execute the revise-phase workflow from @./.opencode/get-physics-done/workflows/revise-phase.md end-to-end.
