...
For agent selection strategy and verification failure routing, see `@./.opencode/get-physics-done/references/orchestration/meta-orchestration.md`.
</required_reading>
...
4. **Spawn executor agents:**
   ...
   task(
     ...
     prompt="First, read ./.opencode/agents/gpd-executor.md for your role and instructions.
       ...
       - Checkpoints ref: ./.opencode/get-physics-done/references/orchestration/checkpoints.md
       - Validation ref: ./.opencode/get-physics-done/references/verification/core/verification-core.md (+ domain-specific verification file)
...
6. **Spawn continuation agent (NOT resume)** using `./.opencode/get-physics-done/templates/continuation-prompt.md` template:
...
```bash
cat ./.opencode/get-physics-done/templates/paper/figure-tracker.md
```
...
Create a recovery section in the phase directory. For physics-specific root cause analysis, consult `./.opencode/get-physics-done/templates/recovery-plan.md`:
...
Follow the verification workflow. Read `./.opencode/get-physics-done/workflows/verify-phase.md` using the read_file tool.
...
task(
  ...
  readonly=false,
  prompt="First, read ./.opencode/agents/gpd-verifier.md for your role and instructions.
...
task(prompt="First, read ./.opencode/agents/gpd-consistency-checker.md for your role and instructions.
...
task(
  ...
  readonly=false,
  prompt="First, read ./.opencode/agents/gpd-notation-coordinator.md for your role and instructions.
...
Follow the full transition protocol. Read `./.opencode/get-physics-done/workflows/transition.md` using the read_file tool for PROJECT.md evolution, DECISIONS.md updates, and parallel phase detection.
...
Read the file at ./.opencode/get-physics-done/workflows/execute-phase.md — this contains the complete step-by-step instructions. Do NOT improvise. Follow the workflow file exactly.
