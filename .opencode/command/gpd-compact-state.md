...
- ./.opencode/get-physics-done/templates/state-archive.md -- Template for STATE-ARCHIVE.md (archive structure, what gets archived, archive format)
</required_reading>
...
<process>
**Follow the compact-state workflow** from `@./.opencode/get-physics-done/workflows/compact-state.md`.
