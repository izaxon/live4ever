...
Use question to establish scope:
...
```
task(
  prompt="First, read ./.opencode/agents/gpd-literature-reviewer.md for your role and instructions.\n\n" + filled_prompt,
