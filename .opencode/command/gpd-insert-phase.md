...
**Reference:** `./.opencode/get-physics-done/references/orchestration/agent-infrastructure.md` — See the `Decimal Phase Calculation` section for the numbering rules and troubleshooting details.
</required_reading>
...
Execute the insert-phase workflow from @./.opencode/get-physics-done/workflows/insert-phase.md end-to-end.
